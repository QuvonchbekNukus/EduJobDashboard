        ...
        <div class="modern-hero mb-4">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                <div>
                    ...
                    <h1 class="modern-title">Employer tahrirlash</h1>
                    <p class="text-muted mb-0">Muassasa ma`lumotlarini yangilang va saqlang.</p>
                </div>
        ...
        <div class="modern-card p-4 p-md-5">
            ...
            <form method="POST" action="{{ route('employers.update', $employer) }}">
                ...
                <div class="mb-3">
                    ...
                    >
                        <option value="" {{ old('org_type', $employer->org_type) ? '' : 'selected' }}>Tanlang</option>
                        <option value="learning_center" {{ old('org_type', $employer->org_type) === 'learning_center' ? 'selected' : '' }}>Learning center</option>
                        <option value="school" {{ old('org_type', $employer->org_type) === 'school' ? 'selected' : '' }}>School</option>
                        <option value="kindergarden" {{ old('org_type', $employer->org_type) === 'kindergarden' ? 'selected' : '' }}>Kindergarden</option>
                    </select>
                    @error('org_type')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    ...
                    >
                        ...
                        @foreach ($regions as $region)
                            <option value="{{ $region->id }}" {{ old('region_id', $employer->region_id) == $region->id ? 'selected' : '' }}>
